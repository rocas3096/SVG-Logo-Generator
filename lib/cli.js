...
class Logo {
    run() {
        this.promptuser()
            .then(({ shapeColor, textColor, text, shape, title }) => {
                let shapeComponent;

                if (shape === 'Circle') {
                    shapeComponent = new Circle(shapeColor, textColor, text);
                } else if (shaoe === 'Square') {
                    shapeComponent = new Square(shapeColor, textColor, text);
                } else if (shape === 'Triangle') {
                    shapeComponent = new Triangle(shapeColor, textColor, text);
                } else {
